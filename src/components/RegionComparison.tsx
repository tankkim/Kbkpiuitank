    ...
    <div className="h-full flex flex-col bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl text-gray-900">Region Comparison</h1>
            <p className="text-sm text-gray-600 mt-1">Regional Performance Analysis</p>
          </div>
      ...
      <div className="flex-1 overflow-auto p-6">
            ...
            <table className="border-collapse text-xs min-w-max w-full">
              <thead className="sticky top-0 z-10">
                ...
                <tr className="bg-[#4a5f7f] text-white">
                  ...
                  <th colSpan={8} className="border border-gray-400 px-2 py-2 bg-blue-700">Performance</th>
                  <th colSpan={8} className="border border-gray-400 px-2 py-2 bg-green-700">Performance</th>
                </tr>
                ...
                <tr className="bg-gray-600 text-white">
                  ...
                  <th className="border border-gray-400 px-2 py-1"></th>
                  <th className="border border-gray-400 px-2 py-1"></th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">I</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">II</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">III</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">IV</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">V</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">VI</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">VII</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">ALL</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">I</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">II</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">III</th>
                  <th className="border border-gray-400 px-2 py-1 min-w-[60px]">IV</th>
              ...
              <tbody>
                ...
                <tr className="bg-gray-700 text-white">
                  <td colSpan={20} className="border border-gray-400 px-2 py-1">Customer</td>
                </tr>
                ...
                <tr className="group bg-white transition-colors">
                  ...
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center bg-red-200 group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                ...
                {/* Financial Section */}
                <tr className="bg-gray-700 text-white">
                  <td colSpan={20} className="border border-gray-400 px-2 py-1">Financial</td>
                </tr>
                ...
                <tr className="group bg-gray-50 transition-colors">
                  ...
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">Bill Rp</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">75</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">113</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                  <td className="border border-gray-300 px-2 py-1 text-center group-hover:bg-blue-100">~</td>
                ...
                <tr className="bg-gray-700 text-white">
                  <td colSpan={20} className="border border-gray-400 px-2 py-1">Learning & Leadership</td>
                </tr>
                ...
                <tr className="bg-gray-700 text-white">
                  <td colSpan={20} className="border border-gray-400 px-2 py-1">Additional Point</td>
                </tr>
                ...
                {/* KPI Result Section */}
                <tr className="bg-gray-700 text-white">
                  <td colSpan={20} className="border border-gray-400 px-2 py-1">KPI RESULT**</td>
                </tr>
                ...
                <tr className="bg-blue-100">
                  <td className="border border-gray-300 px-2 py-1">Region Rank</td>
                  <td className="border border-gray-300 px-2 py-1 text-center"></td>
                  <td className="border border-gray-300 px-2 py-1 text-center"></td>
                  <td className="border border-gray-300 px-2 py-1 text-center"></td>
                  <td className="border border-gray-300 px-2 py-1 text-center"></td>
        ...
        <div className="mt-4 text-xs text-gray-600">
          <p>** KPI, The indicator is not included in the 2025 KPI indicators</p>
          <p>The calculation will be automatically adjusted based on FINSHARE data</p>
        </div>
      </div>
    </div>
  );
